...
def lanes():
    return dict(
        # clap energy: hard early (stress), a BREAK at the breakthrough, then relentless
        effort=S.curve([(0, 0.55), (15, 0.82), (38, 1.0), (44, 1.0), (45.5, 0.2),
                        (50, 0.9), (70, 1.0), (130, 1.0), (155, 0.85), (175, 0.4), (180, 0)], DUR),
        # altitude: struggling low, then LIFTOFF at ~46, then high & wavering
        altitude=S.curve([(0, 0.05), (38, 0.16), (45, 0.2), (52, 0.72), (70, 0.9),
                          (120, 1.0), (150, 0.92), (180, 0.2)], DUR),
        # darkness→brightness: tense, then bright at the breakthrough
        bright=S.curve([(0, 0.06), (40, 0.12), (47, 0.95), (70, 0.9), (140, 0.85), (180, 0.4)], DUR),
        # tension drone: builds the stress, then RELEASES at the breakthrough
        tension=S.curve([(0, 0.4), (20, 0.75), (40, 1.0), (46, 0.18), (90, 0.12),
                         (125, 0.22), (180, 0.1)], DUR),
        # driving bass / momentum: enters at the breakthrough, relentless
        drive=S.curve([(0, 0), (46, 0.25), (55, 0.75), (75, 1.0), (130, 1.0), (155, 0.7), (180, 0.1)], DUR),
        # the cosmos: stress early, recedes at triumph, returns as difficulty
...
def lead(L):
    ...
    while t < 162:
        ...
        out = S.mix_at(out, tone * (0.3 + 0.7 * e), t, gain=0.5 * a * br)
        j += 1; t += step
...
if __name__ == '__main__':
    ...
    organs = {
        ...
        'void': (void(L), 0.80), 'flutes': (flutes(L), 0.42),
    }
    mix = np.zeros((N, 2))
